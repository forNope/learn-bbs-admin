<template>
  <div class="app-container">
    <div style="margin-bottom: 10px;">
      <el-button icon="el-icon-share" type="info" @click="$router.push({name: 'BBSPosts'})">返回</el-button>
      <el-select
        v-model="sort"
        placeholder="请选择"
      >
    ...
    <el-table
      ...
      <el-table-column prop="author.nickname" width="100" label="评论者"/>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button
            size="small"
            @click="$router.push({name: 'BBSReplies', params: {id: scope.row.id}, query: {id: $route.params.id}})">
            查看
          </el-button>
