  ...
  <div class="app-container">
    <div style="margin-bottom: 10px;">
      <el-button
        icon="el-icon-share"
        type="info"
        @click="$router.push({name: 'BBSComments', params: {id: $route.query.id}})">
        返回
      </el-button>
      <el-select
        v-model="sort"
    ...
    <el-table
      ...
      <el-table-column prop="author.nickname" width="100" label="回复者"/>
      <el-table-column prop="replyToAuthor.nickname" width="100" label="接受者"/>
